export default function FilterBar({ filters, setFilters }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full p-4 bg-zinc-900 text-white justify-between items-start lg:items-center gap-4">
      {/* Genre Filter */}
      ...
      {/* Platform Filter */}
      <div className="flex flex-col w-full lg:w-auto">
        <label htmlFor="platform" className="mb-2 text-2xl font-bold">
          Platform
        </label>
        <select
          id="platform"
      ...
      {/* Store Filter */}
      <div className="flex flex-col w-full lg:w-auto">
        <label htmlFor="store" className="mb-2 text-2xl font-bold">
          Store
        </label>
        <select
          id="store"
