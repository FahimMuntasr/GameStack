    ...
    return(
        <>
            <div className="top-0 flex flex-row w-full justify-between h-16 items-center text-xl bg-zinc-950">
                ...
                <Link to="/profile">
                    <span className="text-green-500 hover:text-rose-500 transition-colors duration-100 ease-in">Profile</span>
                </Link>
                <Link to="/games">
                    <span className="text-green-500 hover:text-rose-500 transition-colors duration-100 ease-in">Games</span>
                </Link>
